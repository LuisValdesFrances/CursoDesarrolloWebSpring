	...
	<html>
		...
		<script type="text/javascript">
			jQuery(document).ready(function(){
				//Lanza una advertencia para los elementos de la clase .confirm.
				//Solo deja pasar la peticion en caso de de seleccionar 'Si'
				jQuery(".confirm").on("click", function(){
					//alert("Prueba exitosa");
					return confirm("¿Realmente deseas elininar el registro");
				});
			});
		</script>
	</head>
